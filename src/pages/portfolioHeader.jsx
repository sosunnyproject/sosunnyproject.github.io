...
export default function PortfolioHeader({ data }) {
  ...
  return (
    <div className={containerStyles.pf_subheader_wrapper}>
      <Link to="/portfolio/main" getProps={isActive} className={containerStyles.pf_subheader_btn}>Main</Link>
      <Link to="/portfolio/games" getProps={isActive} className={containerStyles.pf_subheader_btn}>GAMES / APPS</Link>
